				...
				foreach ( $field['value'] as $v ) : ?>
					<div class="thumbnail acf-soh">
						...
						<div class="inner clearfix">
							<h3>Original Video Title: <u><?php echo esc_attr( $v['title'] ); ?></u></h3>
							<a href="<?php echo esc_attr( 'https://www.youtube.com/watch?v=' . $v['vid'] ); ?>" title="<?php echo esc_attr( $v['title'] ); ?>" target="_blank">
								<img src="//i.ytimg.com/vi/<?php echo esc_attr( $v['vid'] ); ?>/maxresdefault.jpg">
							</a>
						</div>
