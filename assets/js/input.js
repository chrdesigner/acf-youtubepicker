			...
			input.on( 'itemSelected', function( e, data ) {
				...
				var item     = '<div class="thumbnail">' +
								...
								'<div class="inner clearfix">' +
									'<h3>Original Video Title: <u>' + data.title + '</u></h3>' +
									'<a href="https://www.youtube.com/watch?v=' + data.vid + '" title="' + data.title + '" target="_blank">' +
									'<img src="http://i.ytimg.com/vi/' + data.vid + '/maxresdefault.jpg" alt="' + data.title + '">' +
									'</a>'+
								'</div>' +
								'<div class="acf-soh">'+
